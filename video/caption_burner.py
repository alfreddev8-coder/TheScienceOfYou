...
Style: Default,DejaVu Sans,130,&H0000FFFF,&H000000FF,&H00000000,&H80000000,-1,0,0,0,100,100,0,0,1,9,0,5,60,40,60,1
Style: Number,DejaVu Sans,135,&H0000FF00,&H000000FF,&H00000000,&H80000000,-1,0,0,0,100,100,0,0,1,9,0,5,60,40,60,1
Style: Organ,DejaVu Sans,130,&H00FFD700,&H000000FF,&H00000000,&H80000000,-1,0,0,0,100,100,0,0,1,9,0,5,60,40,60,1
...
def burn_basic_captions(video_path: str, srt_path: str, output_path: str) -> bool:
    ...
    try:
        style = (
            "FontName=DejaVu Sans,FontSize=130,PrimaryColour=&H0000FFFF,"
            "OutlineColour=&H00000000,Bold=1,Outline=9,Shadow=0,"
